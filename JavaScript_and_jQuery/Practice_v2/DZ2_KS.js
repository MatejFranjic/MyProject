...
//TU NE MIJENJAJ NIŠTA, SAMO PROMIJENI NAZIV FUNKCIJE
function slucajnaBoja() {
    ...
    return "#" + red.toString(16) + green.toString(16) + blue.toString(16); //TU SAM JA PROMIJENIO, TI SAMO NAZIV     
}
...
window.onload = init; //tu isto naziv init promijeni

//promijeniti naziv funkcije i varijabli unutra
function init() {
    //JS dio
